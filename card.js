          ...
          <dialog id="cardDialog" class='rounded-2xl p-6 shadow-2xl mx-8 sm:mx-auto'>
              <div class='flex flex-col h-full'>
                  ...
                  <div class="w-full flex justify-center text-center mt-4">
                      ...
                      <button id="addFavourites" class="bg-blue-600 px-2 h-9 rounded hover:bg-blue-500 font-bold text-white w-1/2 m-1 text-center faveBtn" data-drink='${JSON.stringify(drink)}' >Add<span class="hidden sm:inline"> to favourites</span></button>
                  </div>
              </div>
          </dialog>
      </div> 
